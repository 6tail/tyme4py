...
class TestSolarTerm(unittest.TestCase):
    def test0(self):
        ...
        dongZhi = SolarTerm(2023, '冬至')
        assert dongZhi.get_name() == '冬至'
        assert dongZhi.get_index() == 0
        # 公历日
        assert dongZhi.get_julian_day().get_solar_day().__str__() == '2022年12月22日'
        ...
        assert dongZhi2.get_name() == '冬至'
        assert dongZhi2.get_index() == 0
        assert dongZhi2.get_julian_day().get_solar_day().__str__() == '2023年12月22日'
