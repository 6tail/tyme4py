...
from tyme4py.rabbyung import RabByungDay, RabByungElement, RabByungYear
...
class TestRabByungDay(unittest.TestCase):
    def test0(self):
        ...
        # 测试藏历日转换为公历日
        y: RabByungYear = RabByungYear.from_element_zodiac(15, RabByungElement.from_name('铁'), Zodiac.from_name('虎'))
        rab_day2 = RabByungDay.from_ymd(y.get_year(), 12, 1)
    ...
    def test1(self):
        ...
        # 测试藏历日转换为公历日
        y: RabByungYear = RabByungYear.from_element_zodiac(17, RabByungElement.from_name('铁'), Zodiac.from_name('马'))
        rab_day2 = RabByungDay.from_ymd(y.get_year(), 12, 30)
    ...
    def test2(self):
        ...
        # 测试藏历日转换为公历日
        y: RabByungYear = RabByungYear.from_element_zodiac(16, RabByungElement.from_name('木'), Zodiac.from_name('蛇'))
        rab_day2 = RabByungDay.from_ymd(y.get_year(), 2, 25)
    ...
    def test3(self):
        ...
        # 测试藏历日转换为公历日
        y: RabByungYear = RabByungYear.from_element_zodiac(15, RabByungElement.from_name('铁'), Zodiac.from_name('兔'))
        rab_day2 = RabByungDay.from_ymd(y.get_year(), 1, 2)
    ...
    def test4(self):
        ...
        # 测试藏历日转换为公历日（闰日）
        y: RabByungYear = RabByungYear.from_element_zodiac(15, RabByungElement.from_name('铁'), Zodiac.from_name('虎'))
        rab_day2 = RabByungDay.from_ymd(y.get_year(), 12, -16)
    ...
    def test5(self):
        ...
        # 测试藏历日转换为公历日
        y: RabByungYear = RabByungYear.from_element_zodiac(15, RabByungElement.from_name('铁'), Zodiac.from_name('牛'))
        rab_day2 = RabByungDay.from_ymd(y.get_year(), 5, 11)
    ...
    def test6(self):
        ...
        # 测试藏历日转换为公历日
        y: RabByungYear = RabByungYear.from_element_zodiac(15, RabByungElement.from_name('铁'), Zodiac.from_name('兔'))
        rab_day2 = RabByungDay.from_ymd(y.get_year(), 12, 28)
